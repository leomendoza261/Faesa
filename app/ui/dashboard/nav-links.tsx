...
const links = [
  ...
  { name: 'Cola Ojalado/Matrizado', href: '/dashboard/cola_ojalado_matrizado', logo: <PacientesIcon size={4} strokeWidth={2}/> },
  ...
  { name: 'Cola Temple', href: '/dashboard/cola_temple', logo: <PacientesIcon size={4} strokeWidth={2}/> },
  ...
  { name: 'Engrampado/Embujado', href: '/dashboard/engrampado_embujado', logo: <PacientesIcon size={4} strokeWidth={2}/> },
