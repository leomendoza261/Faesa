...
const links = [
  ...
  { name: 'Matrizado A', href: '/dashboard/matrizado-a', logo: <PacientesIcon size={4} strokeWidth={2}/> },
  { name: 'Matrizado B', href: '/dashboard/matrizado-b', logo: <PacientesIcon size={4} strokeWidth={2}/> },
